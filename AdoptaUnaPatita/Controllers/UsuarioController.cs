...
namespace AdoptaUnaPatita.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,IdRol,Nombre,Contrasenia")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,IdRol,Nombre,Contrasenia")] Usuario usuario)
        {
            if (ModelState.IsValid)
            {
